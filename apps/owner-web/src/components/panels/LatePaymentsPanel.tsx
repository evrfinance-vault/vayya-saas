    ...
    <div className="overview-grid">
      ...
      <SpreadsheetCard<Row>
        ...
        columns={[
          ...
          { key: "outstanding", label: "Outstanding", align: "right", width: "150px" },
          { key: "overdue", label: "Amount Overdue", align: "right", width: "160px" },
          { key: "days", label: "Days Overdue", align: "center", width: "130px" },
          { key: "missed", label: "Missed Payments", align: "center", width: "140px" },
