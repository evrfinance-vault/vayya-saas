...
import { faCircle, faMoneyBillTrendUp, faGrip, faSackDollar, faSackXmark, faSpinner } from "@fortawesome/free-solid-svg-icons";
import { useSearchParams } from "react-router-dom";
import OverviewTabs, { TabKey, TabDef } from "../components/OverviewTabs";
import { ActivePaymentPlansPanel, LatePaymentsPanel, PendingApplicationsPanel, TotalRevenuePanel, VayyaBoardPanel } from "../components/panels";
...
const TABS: TabDef[] = [
  { key: "total-revenue",        icon: faMoneyBillTrendUp, label: "Total Revenue",        badge: "$0,000.00" },
  { key: "active-payment-plans", icon: faSackDollar,       label: "Active Payment Plans", badge: 0 },
  { key: "vayya-board",          icon: faGrip,             label: "Vayya Board",          badge: "" },
  { key: "late-payments",        icon: faSackXmark,        label: "Late Payments",        badge: 0 },
  { key: "pending-applications", icon: faSpinner,          label: "Pending Applications", badge: 0 }
];
  ...
  return (
    ...
    >
      ...
      <section className="page-overview">
        ...
        <div key={tab} id={`panel-${tab}`} role="tabpanel" className="overview-panel overview-tab-change">
